...
app.post('/addWishToUser', (req, res) => {
    dataServices.addWishlistToUser(req.body.id, req.body.name, req.body.os, req.body.price, req.body.image,
...
app.post('/addCartToUser', (req, res) => {
    dataServices.addCartToUser(req.body.id, req.body.name, req.body.os, req.body.price, req.body.image,
        req.body.description, req.body.ram, req.body.discount, req.body.email).then(
            (result) => {
                res.status(result.statusCode).json(result);
            }
        )
